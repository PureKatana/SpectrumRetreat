...
/*! @brief Returns the adapter device m_name of the specified monitor.
 *
 *  @return The UTF-8 encoded adapter device m_name (for example `\\.\DISPLAY1`)
...
/*! @brief Returns the display device m_name of the specified monitor.
 *
 *  @return The UTF-8 encoded display device m_name (for example
