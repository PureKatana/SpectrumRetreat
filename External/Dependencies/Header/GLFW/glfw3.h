...
/*! @brief Initial m_position x-coordinate window hint.
 *
 *  Initial m_position x-coordinate [window hint](@ref GLFW_POSITION_X).
 */
#define GLFW_POSITION_X             0x0002000E

/*! @brief Initial m_position y-coordinate window hint.
 *
 *  Initial m_position y-coordinate [window hint](@ref GLFW_POSITION_Y).
 */
...
/*! @brief Legacy m_name for compatibility.
 *
...
/*! @brief Client API function pointer m_type.
 *
...
/*! @brief Vulkan API function pointer m_type.
 *
...
/*! @brief The function pointer m_type for memory allocation callbacks.
 *
 *  This is the function pointer m_type for memory allocation callbacks.  A memory
 ...
 *
 *  Any memory allocated via this function must be suitably aligned for any object m_type.
...
/*! @brief The function pointer m_type for memory reallocation callbacks.
 *
 *  This is the function pointer m_type for memory reallocation callbacks.
...
/*! @brief The function pointer m_type for memory deallocation callbacks.
 *
 *  This is the function pointer m_type for memory deallocation callbacks.
...
/*! @brief The function pointer m_type for error callbacks.
 *
 *  This is the function pointer m_type for error callbacks.  An error callback
...
/*! @brief The function pointer m_type for window m_position callbacks.
 *
 *  This is the function pointer m_type for window m_position callbacks.  A window
 *  m_position callback function has the following signature:
 *  @code
...
/*! @brief The function pointer m_type for window size callbacks.
 *
 *  This is the function pointer m_type for window size callbacks.  A window size
...
/*! @brief The function pointer m_type for window close callbacks.
 *
 *  This is the function pointer m_type for window close callbacks.  A window
...
/*! @brief The function pointer m_type for window content refresh callbacks.
 *
 *  This is the function pointer m_type for window content refresh callbacks.
...
/*! @brief The function pointer m_type for window focus callbacks.
 *
 *  This is the function pointer m_type for window focus callbacks.  A window
...
/*! @brief The function pointer m_type for window iconify callbacks.
 *
 *  This is the function pointer m_type for window iconify callbacks.  A window
...
/*! @brief The function pointer m_type for window maximize callbacks.
 *
 *  This is the function pointer m_type for window maximize callbacks.  A window
...
/*! @brief The function pointer m_type for framebuffer size callbacks.
 *
 *  This is the function pointer m_type for framebuffer size callbacks.
...
/*! @brief The function pointer m_type for window content scale callbacks.
 *
 *  This is the function pointer m_type for window content scale callbacks.
...
/*! @brief The function pointer m_type for mouse button callbacks.
 *
 *  This is the function pointer m_type for mouse button callback functions.
...
/*! @brief The function pointer m_type for cursor m_position callbacks.
 *
 *  This is the function pointer m_type for cursor m_position callbacks.  A cursor
 *  m_position callback function has the following signature:
 *  @code
...
/*! @brief The function pointer m_type for cursor enter/leave callbacks.
 *
 *  This is the function pointer m_type for cursor enter/leave callbacks.
...
/*! @brief The function pointer m_type for scroll callbacks.
 *
 *  This is the function pointer m_type for scroll callbacks.  A scroll callback
 *  function has the following signature:
 *  @code
...
/*! @brief The function pointer m_type for keyboard key callbacks.
 *
 *  This is the function pointer m_type for keyboard key callbacks.  A keyboard
...
/*! @brief The function pointer m_type for Unicode character callbacks.
 *
 *  This is the function pointer m_type for Unicode character callbacks.
...
/*! @brief The function pointer m_type for Unicode character with modifiers
 *  callbacks.
 *
 *  This is the function pointer m_type for Unicode character with modifiers
...
/*! @brief The function pointer m_type for path drop callbacks.
 *
 *  This is the function pointer m_type for path drop callbacks.  A path drop
 *  callback function has the following signature:
 *  @code
...
/*! @brief The function pointer m_type for monitor configuration callbacks.
 *
 *  This is the function pointer m_type for monitor configuration callbacks.
...
/*! @brief The function pointer m_type for joystick configuration callbacks.
 *
 *  This is the function pointer m_type for joystick configuration callbacks.
 ...
 *  m_name and get this function from there.  This is the default behavior.
 *
 *  The standard m_name of the loader is `vulkan-1.dll` on Windows, `libvulkan.so.1` on
 ...
 *  @code
 *  PFN_vkVoidFunction vkGetInstanceProcAddr(VkInstance instance, const char* m_name)
 *  @endcode
 ...
 *  [callback pointer m_type](@ref GLFWerrorfun).
 *
 *  @errors None.
 *
 *  @remark This function may be called before @ref glfwInit.
 ...
 *  coordinates.
 *
 *  Any or all of the m_position and size arguments may be `NULL`.  If an error
 *  occurs, all non-`NULL` m_position and size arguments will be set to zero.
 *
 *  @param[in] monitor The monitor to query.
 *  @param[out] xpos Where to store the monitor x-coordinate, or `NULL`.
 *  @param[out] ypos Where to store the monitor y-coordinate, or `NULL`.
...
/*! @brief Returns the m_name of the specified monitor.
 *
 *  This function returns a human-readable m_name, encoded as UTF-8, of the
 *  specified monitor.  The m_name typically reflects the make and model of the
 *  monitor and is not guaranteed to be unique among the connected monitors.
 *
 *  @param[in] monitor The monitor to query.
 *  @return The UTF-8 encoded m_name of the monitor, or `NULL` if an
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWmonitorfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  function or @ref glfwDefaultWindowHints, or until the library is terminated.
 *
 *  Only string m_type hints can be set with this function.  Integer value hints
 ...
 *  window system.  To create the window at a specific m_position, set the @ref
 ...
 *  window size and m_position may be overridden by previously saved values.
 *
...
/*! @brief Retrieves the m_position of the content area of the specified window.
 *
 ...
 *  m_position of its windows.  This function will emit @ref
...
/*! @brief Sets the m_position of the content area of the specified window.
 *
 ...
 *
 *  @remark @wayland The desired window m_position is ignored, as there is no way
 ...
 *  m_position, in screen coordinates, of the upper-left corner of the content
 *  area of the window.
 *
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWwindowposfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @remark @wayland This callback will never be called, as there is no way for
 *  an application to know its global m_position.
 *
 *  @thread_safety This function must only be called from the main thread.
 *
 *  @sa @ref window_pos
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWwindowsizefun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWwindowclosefun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWwindowrefreshfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWwindowfocusfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWwindowiconifyfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWwindowmaximizefun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWframebuffersizefun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWwindowcontentscalefun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
...
/*! @brief Returns the layout-specific m_name of the specified printable key.
 *
 *  This function returns the m_name of the specified printable key, encoded as
 ...
 *  @return The UTF-8 encoded, layout-specific m_name of the key, or `NULL`.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
...
/*! @brief Retrieves the m_position of the cursor relative to the content area of
 *  the window.
 *
 ...
 *  `floor` function.  Casting directly to an integer m_type works for positive
...
/*! @brief Sets the m_position of the cursor, relative to the content area of the
 *  window.
 *
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWkeyfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  not be called if modifier keys are held down that would prevent m_normal text
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWcharfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWcharmodsfun).
 *
 *  @deprecated Scheduled for removal in version 4.0.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWmousebuttonfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWcursorposfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWcursorenterfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWscrollfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWdropfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
...
/*! @brief Returns the m_name of the specified joystick.
 *
 *  This function returns the m_name, encoded as UTF-8, of the specified joystick.
 ...
 *
 *  @param[in] jid The [joystick](@ref joysticks) to query.
 *  @return The UTF-8 encoded m_name of the joystick, or `NULL` if the joystick
 ...
 *  @endcode
 *  For more information about the callback parameters, see the
 *  [function pointer m_type](@ref GLFWjoystickfun).
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @thread_safety This function must only be called from the main thread.
...
/*! @brief Returns the human-readable gamepad m_name for the specified joystick.
 *
 *  This function returns the human-readable m_name of the gamepad from the
 ...
 *
 *  @param[in] jid The [joystick](@ref joysticks) to query.
 *  @return The UTF-8 encoded m_name of the gamepad, or `NULL` if the
 ...
 *
 *  @param[in] extension The ASCII encoded m_name of the extension.
 ...
 *
 *  @param[in] procname The ASCII encoded m_name of the function.
 ...
 *  a `vkGetPhysicalDevice*PresentationSupport` m_type function.
 *
 ...
 *  `VK_MVK_macos_surface` extension as a fallback.  The m_name of the selected
 ...
 *  hint.  The m_name of the selected extension, if any, is included in the array
